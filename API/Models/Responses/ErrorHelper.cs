...
{
    public static class ErrorHelper<T>
    {
        public static PagedResponse<T> GetPagedResponse(string url, IEnumerable<T> result, int pageNumber, int pageSize, int totalImages)
        {
